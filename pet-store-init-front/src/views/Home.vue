        ...
        <el-row :gutter="20">
          ...
          <el-col :span="5" >
            <el-card :body-style="{ padding: '0px' }">
              ...
              <el-row>
                <el-button type="primary" :disabled="adoptList[1]" @click="adopt(1)">领养</el-button>
              </el-row>
            </el-card>
          </el-col>
          <el-col :span="5" >
            <el-card :body-style="{ padding: '0px' }">
              ...
              <el-row>
                <el-button type="primary" :disabled="adoptList[2]" @click="adopt(2)">领养</el-button>
              </el-row>
            </el-card>
          </el-col>
          <el-col :span="5" >
            <el-card :body-style="{ padding: '0px' }">
              ...
              <el-row>
                <el-button type="primary" :disabled="adoptList[3]" @click="adopt(3)">领养</el-button>
              </el-row>
            </el-card>
          </el-col>
        </el-row>
        <el-row :gutter="20" style="margin-top: 2%">
          <el-col :span="5" :offset="1">
            <el-card :body-style="{ padding: '0px' }">
              ...
              <el-row>
                <el-button type="primary" :disabled="adoptList[4]" @click="adopt(4)">领养</el-button>
              </el-row>
            </el-card>
          </el-col>
          <el-col :span="5">
            <el-card :body-style="{ padding: '0px' }">
              ...
              <el-row>
                <el-button type="primary" :disabled="adoptList[5]" @click="adopt(5)">领养</el-button>
              </el-row>
            </el-card>
          </el-col>
          <el-col :span="5" >
            <el-card :body-style="{ padding: '0px' }">
              ...
              <el-row>
                <el-button type="primary" :disabled="adoptList[6]" @click="adopt(6)">领养</el-button>
              </el-row>
            </el-card>
          </el-col>
          <el-col :span="5" >
            <el-card :body-style="{ padding: '0px' }">
              ...
              <el-row>
                <el-button type="primary" :disabled="adoptList[7]" @click="adopt(7)">领养</el-button>
              </el-row>
            </el-card>
          </el-col>
        </el-row>
...
export default {
  ...
  methods: {
    ...
    adopt: function (petId){
      ...
      console.log(address);
      console.log(petId);
      this.axios.get(`myAdoption/adopt?address=${address}&petId=${petId}`).then((response)=>{
        if(response.data.code === 200){
          alert("领养成功!")
